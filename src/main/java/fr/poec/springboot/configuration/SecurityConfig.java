package fr.poec.springboot.configuration;

import fr.poec.springboot.configuration.jwt.JwtTokenFilter;
        ...
        http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.POST, "/api/userOwnGame").authenticated()
